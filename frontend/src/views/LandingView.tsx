...
require('../assets/css/LandingView.css');
    ...
    <div className="LandingView">
        ...
        <div className="middle-content">
            <div className="search-container">
                ...
                <input type="text" className="professor" placeholder="Twój profesor"/>
                <input type="text" className="school" placeholder="Nazwa uczelni"/>
